    ...
    <template v-else>
      ...
      <Teleport to="body">
        ...
        <div v-if="isOnActiveTrial && !isActivePaidUser"
          ...
          <span class="trial-banner-hide-mobile" style="font-size:12px;color:#6b7280;">—</span>
          <span class="trial-banner-hide-mobile" style="font-size:12px;color:#9ca3af;">Download graphics, expand everything, no limits.</span>
        ...
        <div v-else-if="isTrialExpired && !isActivePaidUser && !isOnActiveTrial"
          ...
          <span class="trial-banner-hide-mobile" style="font-size:12px;color:#6b7280;">—</span>
          <span class="trial-banner-hide-mobile" style="font-size:12px;color:#9ca3af;">Subscribe to restore full access.</span>
          <button @click="$router.push('/pricing')"
...
.helper-pop-enter-active { transition: all 0.25s cubic-bezier(0.34, 1.56, 0.64, 1); }
...
<style>
/* Trial banner mobile — hide description text so banner stays one line */
@media (max-width: 640px) {
  .trial-banner-hide-mobile { display: none !important; }
}
</style>
