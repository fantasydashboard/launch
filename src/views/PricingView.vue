    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div v-if="purchaseSuccess" class="mb-8 rounded-2xl p-6 flex items-start gap-4" style="background: rgba(34,197,94,0.1); border: 1px solid rgba(34,197,94,0.4);">
        ...
        <div>
          ...
          <p class="text-sm" style="color: #9ca3af;">Your purchase was successful. Full access is now unlocked for your entire league — any league mate who signs up and connects their account will get in automatically.</p>
        ...
        <div class="p-8 sm:p-12">
          <div class="flex flex-col sm:flex-row items-start sm:items-center gap-6">
            ...
            <div class="flex-1">
              ...
              <p class="text-base sm:text-lg" style="color: #9ca3af;">When <strong class="text-white">anyone</strong> in your league buys League Pass, every single member gets full access — automatically, no codes, no invites.</p>
              <div class="flex flex-wrap items-center gap-4 mt-4">
                ...
                <div class="flex items-center gap-2 text-sm" style="color: #6b7280;"><span style="color: #22c55e;">✓</span><span>Instant access, no waiting</span></div>
              </div>
            </div>
        ...
        <div class="rounded-2xl border-2 p-8 relative" style="background: linear-gradient(135deg, rgba(34,197,94,0.08) 0%, rgba(6,182,212,0.05) 100%); border-color: #22c55e;">
          ...
          <div class="text-center mb-2">
            <div class="flex items-center justify-center gap-3 mb-1">
              ...
              <span class="px-2 py-0.5 rounded text-sm font-bold" style="background: rgba(234,179,8,0.2); color: #eab308; border: 1px solid rgba(234,179,8,0.3);">$10 OFF</span>
            </div>
          ...
          <div class="rounded-xl p-4 mb-6" style="background: rgba(0,0,0,0.3);">
            ...
            <p class="text-xs text-dark-textMuted mt-2">Less than a coffee for the whole season</p>
          </div>
          <ul class="space-y-3 mb-8">
      ...
      <div class="mb-16">
        ...
        <div class="grid md:grid-cols-3 gap-8">
          <div class="text-center">
            ...
            <p class="text-dark-textMuted text-sm">The commissioner or any league member buys League Pass for the league.</p>
          </div>
          <div class="text-center">
          ...
          <div class="text-center">
            ...
            <p class="text-dark-textMuted text-sm">We detect they're in your league and unlock full access automatically. No codes needed.</p>
          </div>
        </div>
      </div>
      ...
      <div class="rounded-2xl p-8 text-center mb-8" style="background: linear-gradient(135deg, #0f1118 0%, #0c0f1c 100%); border: 1px solid rgba(34,197,94,0.2);">
        ...
        <p class="text-xs mt-4" style="color: #4b5563;">Usually ${{ regularPrice }} · $10 off for a limited time</p>
      </div>
...
async function purchaseLeaguePass() {
  ...
  try {
    ...
    if (!res.ok) {
      checkoutError.value = res.status === 409 ? 'Great news — this league already has an active League Pass for this season!' : (data.error || 'Something went wrong. Please try again.')
      return
    }
...
const faqs = [
  { question: "What happens when the season ends?", answer: "Your League Pass is valid for the entire season — including the offseason. When the next season's games begin, you'll need to renew. Your historical data is always preserved." },
  ...
  { question: "What is Ultimate Tools and is it really free?", answer: "Ultimate Tools includes AI-powered features like projections, start/sit advice, and waiver analysis. During beta it's included free with every League Pass. Pricing will be introduced after beta ends — early customers will get the best rates." },
  { question: "How does automatic access work for league mates?", answer: "When your league mates create a free account and connect their fantasy account, our system automatically detects they're in a League Pass league and unlocks full access for them — no codes or invites needed." },
  { question: "Is the $19 price going up?", answer: "Yes — $19 is our launch price, $10 off the regular $29/season. Lock in the launch price now before it increases." }
]
