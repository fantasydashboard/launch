        ...
        <div class="card-header">
          <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            ...
            <div class="flex items-center gap-2 flex-shrink-0">
              ...
              <button @click="downloadRankings" :disabled="isGeneratingDownload" class="px-4 py-2 bg-yellow-400 hover:bg-yellow-500 text-gray-900 rounded-lg font-medium flex items-center gap-2 transition-colors disabled:opacity-50">
