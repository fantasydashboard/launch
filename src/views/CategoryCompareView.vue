          ...
          <div class="card">
            <div class="card-header">
              <div class="flex items-center justify-between">
                ...
                >
                  <svg v-if="!isDownloadingComparison" class="w-4 h-4 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 5H6a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2v-1M8 5a2 2 0 002 2h2a2 2 0 002-2M8 5a2 2 0 012-2h2a2 2 0 012 2m0 0h2a2 2 0 012 2v3m2 4H10m0 0l3-3m-3 3l3 3" /></svg>
        ...
        <div style="display: flex; align-items: center; padding: 12px 20px; border-bottom: 1px solid rgba(250, 204, 21, 0.2);">
          ...
          <div style="flex: 1;">
            ...
            <div style="font-size: 12px; margin-top: 2px;">
              ...
              <span style="color: #facc15; font-weight: 600;">${seasonsLoaded.value} Season${seasonsLoaded.value !== 1 ? 's' : ''}</span>
            </div>
          </div>
        </div>
