    ...
    <template v-else-if="powerRankings.length > 0">
      ...
      <div class="card">
        ...
        <div class="card-body">
            ...
            <table class="w-full">
              ...
              <tbody>
                <tr 
                  ...
                  :key="team.team_key"
                  @click="canExpand || idx < 3 ? openTeamDetailModal(team) : null"
          ...
          <!-- Locked rows hint -->
          <div v-if="!canExpand" style="padding:8px 16px;border-top:1px solid #1e2130;display:flex;align-items:center;gap:6px;">
            <span style="font-size:12px;">🔒</span>
            <span style="font-size:12px;color:#374151;font-style:italic;">More teams locked — upgrade to unlock full rankings</span>
          </div>
        </div>
      </div>
