...
<div style="display:flex;justify-content:flex-start;margin-bottom:5px;"><div style="background:#e5e7eb;color:#111827;font-size:9px;font-weight:500;padding:6px 10px;border-radius:14px 14px 14px 2px;max-width:78%;line-height:1.3;">how do I get this??</div></div>
          ...
          <div>
            ...
            <div style="width:1080px;height:1920px;background:#080c14;position:relative;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;transform-origin:top left;transform:scale(0.28125);">
              ...
              <div style="position:absolute;right:-120px;top:140px;bottom:-120px;display:flex;align-items:center;justify-content:flex-end;">
              ...
              <div style="position:absolute;right:10px;top:10px;bottom:10px;width:600px;display:flex;align-items:center;justify-content:center;">
                ...
                <div style="width:340px;height:660px;background:linear-gradient(160deg,#1e2535 0%,#0d1117 50%,#0a0d1a 100%);border-radius:42px;border:1.5px solid rgba(234,179,8,0.25);overflow:hidden;position:relative;z-index:1;box-shadow:0 0 0 1px rgba(255,255,255,0.06),0 50px 100px rgba(0,0,0,0.8),inset 0 1px 0 rgba(255,255,255,0.08);">
                  ...
                  <div style="position:absolute;top:31px;left:0;right:0;bottom:0;background:#0d1117;padding:9px;display:flex;flex-direction:column;gap:7px;overflow:hidden;">
                    ...
                    <div style="background:#131720;border:1px solid rgba(6,182,212,0.2);border-radius:9px;padding:9px 11px;flex-shrink:0;"><div style="font-size:9px;font-weight:800;color:#fff;text-transform:uppercase;letter-spacing:0.05em;margin-bottom:6px;">🎲 Win Probability</div><div style="display:flex;gap:5px;margin-bottom:7px;"><div style="flex:1;background:rgba(6,182,212,0.08);border:1px solid rgba(6,182,212,0.2);border-radius:7px;padding:6px;text-align:center;"><div style="font-size:8px;color:#06b6d4;font-weight:700;">Swamp Pirates</div><div style="font-size:16px;font-weight:900;color:#06b6d4;">72%</div></div><div style="display:flex;align-items:center;font-size:8px;color:#374151;font-weight:700;">VS</div><div style="flex:1;background:rgba(249,115,22,0.08);border:1px solid rgba(249,115,22,0.2);border-radius:7px;padding:6px;text-align:center;"><div style="font-size:8px;color:#f97316;font-weight:700;">NC Pale Hose</div><div style="font-size:16px;font-weight:900;color:#f97316;">28%</div></div></div><div style="height:5px;border-radius:3px;background:rgba(249,115,22,0.3);position:relative;overflow:hidden;"><div style="position:absolute;left:0;top:0;height:100%;width:72%;background:linear-gradient(90deg,#06b6d4,#0891b2);border-radius:3px;"></div></div></div>
<div style="background:#131720;border:1px solid rgba(6,182,212,0.15);border-radius:9px;padding:9px 11px;flex-shrink:0;"><div style="font-size:8px;font-weight:700;color:#6b7280;text-transform:uppercase;letter-spacing:0.05em;margin-bottom:4px;">📊 Daily Trend</div><svg viewBox="0 0 220 80" style="width:100%;display:block;"><line x1="20" y1="8" x2="200" y2="8" stroke="#1e2130" stroke-width="1"/><line x1="20" y1="30" x2="200" y2="30" stroke="#374151" stroke-width="1" stroke-dasharray="3,3"/><line x1="20" y1="52" x2="200" y2="52" stroke="#1e2130" stroke-width="1"/><line x1="20" y1="72" x2="200" y2="72" stroke="#1e2130" stroke-width="1"/><text x="2" y="11" font-size="6" fill="#4b5563" font-family="Arial">100%</text><text x="2" y="33" font-size="6" fill="#6b7280" font-family="Arial">50%</text><text x="2" y="75" font-size="6" fill="#4b5563" font-family="Arial">0%</text><path d="M20,28 C50,25 80,20 110,16 C140,12 165,9 200,8" fill="none" stroke="#06b6d4" stroke-width="2" stroke-linecap="round"/><path d="M20,32 C50,35 80,40 110,44 C140,48 165,51 200,52" fill="none" stroke="#f97316" stroke-width="2" stroke-linecap="round"/><path d="M20,28 C50,25 80,20 110,16 C140,12 165,9 200,8 L200,72 L20,72 Z" fill="rgba(6,182,212,0.1)"/><path d="M20,32 C50,35 80,40 110,44 C140,48 165,51 200,52 L200,72 L20,72 Z" fill="rgba(249,115,22,0.1)"/><rect x="12" y="21" width="18" height="11" rx="3" fill="#06b6d4"/><text x="21" y="29" text-anchor="middle" font-size="6" font-weight="800" fill="#0a0c14" font-family="Arial">58</text><rect x="90" y="9" width="20" height="11" rx="3" fill="#06b6d4"/><text x="100" y="17" text-anchor="middle" font-size="6" font-weight="800" fill="#0a0c14" font-family="Arial">64</text><rect x="180" y="2" width="20" height="11" rx="3" fill="#06b6d4"/><text x="190" y="10" text-anchor="middle" font-size="6" font-weight="800" fill="#0a0c14" font-family="Arial">72</text><rect x="12" y="28" width="18" height="11" rx="3" fill="#f97316"/><text x="21" y="36" text-anchor="middle" font-size="6" font-weight="800" fill="#0a0c14" font-family="Arial">42</text><rect x="180" y="45" width="20" height="11" rx="3" fill="#f97316"/><text x="190" y="53" text-anchor="middle" font-size="6" font-weight="800" fill="#0a0c14" font-family="Arial">28</text><text x="20" y="79" text-anchor="middle" font-size="6" fill="#6b7280" font-family="Arial">Mon</text><text x="65" y="79" text-anchor="middle" font-size="6" fill="#6b7280" font-family="Arial">Wed</text><text x="110" y="79" text-anchor="middle" font-size="6" fill="#6b7280" font-family="Arial">Fri</text><text x="155" y="79" text-anchor="middle" font-size="6" fill="#6b7280" font-family="Arial">Sat</text><text x="200" y="79" text-anchor="middle" font-size="6" fill="#6b7280" font-family="Arial">Sun</text></svg></div>
