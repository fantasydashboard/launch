...
/* TRIAL_ENDING_HTML deleted: the trial was retired and grants nothing, so an email
   announcing its end is announcing nothing. */

/* TRIAL_EXPIRED_HTML deleted: the trial was retired and grants nothing, so an email
   announcing its end is announcing nothing. */
