...
// Proxy for ESPN Fantasy Baseball players API
// Avoids browser CORS restrictions on fantasy.espn.com
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    // Cache for 1 hour — ownership doesn't change minute to minute
